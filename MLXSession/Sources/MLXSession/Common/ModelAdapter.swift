...
extension LanguageModel {
    ...
    /// ```
    internal func load(adapter: ModelAdapter) throws {
    ...
    /// ```
    internal func fuse(with adapter: ModelAdapter) throws {
    ...
    /// ```
    internal func unload(adapter: ModelAdapter) {
