...
internal final class ModelAdapterFactory: Sendable {

    /// Shared instance of the adapter factory.
    internal static let shared = ModelAdapterFactory(
    ...
    internal let registry: ModelAdapterTypeRegistry

    internal init(registry: ModelAdapterTypeRegistry) {
