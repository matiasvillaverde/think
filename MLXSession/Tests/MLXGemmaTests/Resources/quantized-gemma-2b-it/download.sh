...
# Download Gemma-2B model from Hugging Face using Git
# Repository: mlx-community/quantized-gemma-2b-it

MODEL_NAME="Gemma-2B"
REPO_URL="https://huggingface.co/mlx-community/quantized-gemma-2b-it"
LOCAL_DIR="."
CLEANUP_GIT="false"
