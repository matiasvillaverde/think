...
# Download Exaone-4.0 model from Hugging Face using Git
# Repository: mlx-community/exaone-4.0-1.2b-4bit

MODEL_NAME="Exaone-4.0"
REPO_URL="https://huggingface.co/mlx-community/exaone-4.0-1.2b-4bit"
LOCAL_DIR="."
CLEANUP_GIT="false"
