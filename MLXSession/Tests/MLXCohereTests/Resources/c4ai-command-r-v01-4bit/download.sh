...
# Download Command-R model from Hugging Face using Git
# Repository: mlx-community/c4ai-command-r-v01-4bit

MODEL_NAME="Command-R"
REPO_URL="https://huggingface.co/mlx-community/c4ai-command-r-v01-4bit"
LOCAL_DIR="."
CLEANUP_GIT="false"
