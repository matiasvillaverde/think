...
# Download InternLM2 model from Hugging Face using Git
# Repository: mlx-community/internlm2-chat-1_8b-4bit

MODEL_NAME="InternLM2"
REPO_URL="https://huggingface.co/mlx-community/internlm2-chat-1_8b-4bit"
LOCAL_DIR="."
CLEANUP_GIT="false"
