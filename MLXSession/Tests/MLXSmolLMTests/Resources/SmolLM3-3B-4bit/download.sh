...
# Download SmolLM3-3B model from Hugging Face using Git
# Repository: mlx-community/SmolLM3-3B-4bit

MODEL_NAME="SmolLM3-3B"
REPO_URL="https://huggingface.co/mlx-community/SmolLM3-3B-4bit"
LOCAL_DIR="."
CLEANUP_GIT="false"
