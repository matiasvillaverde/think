...
# Download Baichuan-M1 model from Hugging Face using Git
# Repository: mlx-community/Baichuan-M1-14B-Instruct-4bit-ft

MODEL_NAME="Baichuan-M1"
REPO_URL="https://huggingface.co/mlx-community/Baichuan-M1-14B-Instruct-4bit-ft"
LOCAL_DIR="."
CLEANUP_GIT="false"
