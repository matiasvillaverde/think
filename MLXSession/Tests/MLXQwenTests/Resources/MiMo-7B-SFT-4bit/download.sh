...
# Download MiMo-7B model from Hugging Face using Git
# Repository: mlx-community/MiMo-7B-SFT-4bit

MODEL_NAME="MiMo-7B"
REPO_URL="https://huggingface.co/mlx-community/MiMo-7B-SFT-4bit"
LOCAL_DIR="."
CLEANUP_GIT="false"
