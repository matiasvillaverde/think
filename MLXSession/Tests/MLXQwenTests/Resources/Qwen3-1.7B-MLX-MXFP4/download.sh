...
# Download Qwen3-1.7B-MLX-MXFP4 model from Hugging Face using Git
# Repository: mlx-community/Qwen3-1.7B-MLX-MXFP4

MODEL_NAME="Qwen3-1.7B-MLX-MXFP4"
REPO_URL="https://huggingface.co/mlx-community/Qwen3-1.7B-MLX-MXFP4"
LOCAL_DIR="."
CLEANUP_GIT="false"
