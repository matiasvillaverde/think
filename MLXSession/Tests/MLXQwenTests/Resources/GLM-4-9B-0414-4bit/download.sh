...
# Download GLM-4-9B model from Hugging Face using Git
# Repository: mlx-community/GLM-4-9B-0414-4bit

MODEL_NAME="GLM-4-9B"
REPO_URL="https://huggingface.co/mlx-community/GLM-4-9B-0414-4bit"
LOCAL_DIR="."
CLEANUP_GIT="false"
