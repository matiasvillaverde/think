...
# Download Qwen2-0.5B model from Hugging Face using Git
# Repository: mlx-community/Qwen1.5-0.5B-Chat-4bit

MODEL_NAME="Qwen2-0.5B"
REPO_URL="https://huggingface.co/mlx-community/Qwen1.5-0.5B-Chat-4bit"
LOCAL_DIR="."
CLEANUP_GIT="false"
