...
# Download ERNIE-4.5 model from Hugging Face using Git
# Repository: mlx-community/ERNIE-4.5-0.3B-PT-bf16-ft

MODEL_NAME="ERNIE-4.5"
REPO_URL="https://huggingface.co/mlx-community/ERNIE-4.5-0.3B-PT-bf16-ft"
LOCAL_DIR="."
CLEANUP_GIT="false"
