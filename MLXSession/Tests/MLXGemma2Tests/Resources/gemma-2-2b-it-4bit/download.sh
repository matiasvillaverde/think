...
# Download Gemma-2-2B model from Hugging Face using Git
# Repository: mlx-community/gemma-2-2b-it-4bit

MODEL_NAME="Gemma-2-2B"
REPO_URL="https://huggingface.co/mlx-community/gemma-2-2b-it-4bit"
LOCAL_DIR="."
CLEANUP_GIT="false"
