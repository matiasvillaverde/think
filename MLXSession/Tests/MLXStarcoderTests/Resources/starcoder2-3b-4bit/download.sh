...
# Download Starcoder2-3B model from Hugging Face using Git
# Repository: mlx-community/starcoder2-3b-4bit

MODEL_NAME="Starcoder2-3B"
REPO_URL="https://huggingface.co/mlx-community/starcoder2-3b-4bit"
LOCAL_DIR="."
CLEANUP_GIT="false"
