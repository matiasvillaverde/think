...
MODELS=(
  ...
  "Tests/MLXGemmaTests/Resources/gemma-3-1b-it-qat-4bit"
  "Tests/MLXGemmaTests/Resources/gemma-3n-E2B-it-lm-4bit"
  "Tests/MLXGraniteTests/Resources/granite-3.3-2b-instruct-4bit"
  "Tests/MLXGemma3VLMTests/Resources/gemma-3-4b-it-qat-3bit"
  "Tests/MLXInternLMTests/Resources/internlm2_5-7b-chat-4bit"
  ...
  "Tests/MLXMambaTests/Resources/mamba-130m-hf-f32"
  "Tests/MLXMamba2Tests/Resources/mamba2-370m"
  "Tests/MLXFalconH1Tests/Resources/Falcon-H1-0.5B-Instruct-4bit"
  "Tests/MLXGraniteHybridTests/Resources/granite-4.0-h-tiny-4bit"
  "Tests/MLXLFM2MoETests/Resources/LFM2-8B-A1B-4bit"
  "Tests/MLXQwen3VLTests/Resources/Qwen3-VL-4B-Instruct-3bit"
