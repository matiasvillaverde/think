...
@Suite("Harmony Test: Harmony Input Test Simple Convo")
internal struct HarmonyInputTestSimpleConvo {
    @Test(
        "Validates harmony_input_test_simple_convo",
    ...
    func test(architecture: Architecture) async throws {
        ...
        let expectedOutput = try loadResource("harmony_input_test_simple_convo")
