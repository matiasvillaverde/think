...
@Suite("Harmony Test: Harmony Input Test Simple Convo High Effort")
internal struct HarmonyInputTestSimpleConvoHighEffort {
    @Test(
        "Validates harmony_input_test_simple_convo_high_effort",
    ...
    func test(architecture: Architecture) async throws {
        ...
        let expectedOutput = try loadResource("harmony_input_test_simple_convo_high_effort")
