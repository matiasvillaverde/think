...
@Suite("Harmony Test: Harmony Input Test Simple Convo Low Effort")
internal struct HarmonyInputTestSimpleConvoLowEffort {
    @Test(
        "Validates harmony_input_test_simple_convo_low_effort",
    ...
    func test(architecture: Architecture) async throws {
        ...
        let expectedOutput = try loadResource("harmony_input_test_simple_convo_low_effort")
