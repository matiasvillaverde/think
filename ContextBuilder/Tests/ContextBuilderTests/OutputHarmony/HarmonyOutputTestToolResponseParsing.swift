...
@Suite("Harmony Test: Harmony Output Test Tool Response Parsing")
internal struct HarmonyOutputTestToolResponseParsing {
    @Test(
        "Validates harmony_output_test_tool_response_parsing",
    ...
    func test(architecture: Architecture) async throws {
        ...
        let expectedOutput = try loadResource("harmony_output_test_tool_response_parsing")
