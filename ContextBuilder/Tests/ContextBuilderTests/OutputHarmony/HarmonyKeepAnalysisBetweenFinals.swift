...
@Suite("Harmony Test: Harmony Output Test Keep Analysis Between Finals")
internal struct HarmonyKeepAnalysisBetweenFinals {
    @Test(
        "Validates harmony_output_test_keep_analysis_between_finals",
    ...
    func test(architecture: Architecture) async throws {
        ...
        let expectedOutput = try loadResource("harmony_output_test_keep_analysis_between_finals")
