...
@Suite("Harmony Test: Harmony Input Test Simple Convo Medium Effort No Instruction")
internal struct HarmonySimpleConvoMediumNoInstr {
    @Test(
        "Validates harmony_input_test_simple_convo_medium_effort_no_instruction",
    ...
    func test(architecture: Architecture) async throws {
        ...
        let expectedOutput = try loadResource(
            "harmony_input_test_simple_convo_medium_effort_no_instruction"
        )
