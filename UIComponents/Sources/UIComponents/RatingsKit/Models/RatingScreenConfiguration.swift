...
/// ```
@MainActor
internal struct RatingScreenConfiguration {
    ...
    ///
    /// - Parameters:
    ///   - screenTitle: The title shown at the top of the rating screen.
    ///     Defaults to "Help Us Grow".
    ...
    ///   - memojis: An array of images to be displayed as memojis.
    ///     Defaults to a predefined set of memojis.
    internal init(
