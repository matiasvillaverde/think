...
public struct PipelineConfiguration: Hashable {
    ...
    public var encoderScaleFactor: Float32 = 0.182_15
    /// Scale factor to use on the latent before decoding
    public var decoderScaleFactor: Float32 = 0.182_15
    ...
    /// `cropsCoordsTopLeft` can be used to generate an image that appears to be "cropped"
    /// from the position `cropsCoordsTopLeft` downwards.
